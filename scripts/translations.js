const TRANSLATIONS = {
  ...
  it: {
    ...
    aboutObsBody:       'Il soggetto manifesta una scioltezza inquietante attraverso ambiti che, in un singolo individuo, non dovrebbero coesistere. Sono pervenute testimonianze relative a episodi di <em>conoscenza inspiegabile</em> &mdash; risposte corrette offerte a domande mai poste, riferimenti a testi che il soggetto non avrebbe potuto leggere. Capace di transitare attraverso la materia e i temi con uguale destrezza: dove un osservatore riferisce di un fisico, un altro, la stessa sera, riferisce di uno scrittore, di un designer, di un traduttore, di un mediatore. Si adatta a qualunque contesto nel giro di pochi minuti &mdash; <em>lingua, postura, registro, idioma</em> &mdash; in una maniera tale da suggerire che il soggetto non assuma forme, bensì le selezioni da un inventario in precedenza catalogato. È stato avvistato mentre attraversava la landa, tra le lingue, tra le discipline, tra stanze gremite di estranei, con il medesimo passo pacato. Considerato <em class="obs-green">non ostile</em>, ma decisamente <span class="redacted">&#9608;&#9608;&#9608;&#9608;&#9608;&#9608;&#9608;</span> &mdash; il soggetto non sembra fissarsi in alcuna forma definita, e si raccomanda agli agenti sul campo di astenersi dal tentare di definirlo.',
  ...
  zh: {
    ...
    aboutObsLabel:      '// 觀察日誌',
    aboutObsBody:       '受觀察者於諸般本不應共存於單一個體之中的領域之間，展現出一種令人不安的流利。據報告所述，曾出現<em>無從解釋之知識</em>——對從未被提出的問題給出正確的解答，提及其本不可能讀過的文本。其得以同樣輕巧地，於物質與題材之間流轉自如：當一位觀察者描述其為一名物理學家之際，另一位於同一夜晚，卻描述其為一名作家、設計師、譯者、中介者。能於數分鐘之內，融入任何環境——<em>語言、姿態、語域、語氣</em>——其方式之純熟，令人懷疑受觀察者並非在「採取」某種形態，而是自一份早已歸檔之名錄中，「擇取」其一。曾被目擊於荒原之中穿行，於語言之間、於學科之間、於滿是陌生人的房間之間，皆以同一份不疾不徐的步調而行。經評估為<em class="obs-green">無敵意</em>，然絕對<span class="redacted">&#9608;&#9608;&#9608;&#9608;&#9608;&#9608;&#9608;</span>——受觀察者似乎不會落定於任何單一形態，故建議外勤探員，切勿嘗試對其加以定義。',
